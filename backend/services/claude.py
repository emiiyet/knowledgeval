...
def extraire_connaissances(pdf_bytes: bytes) -> list[dict]:
    """
    Envoie le PDF à Claude et retourne une liste de connaissances extraites.
    En cas d'erreur (crédits insuffisants, etc.), retourne des données de démo.
    """
    try:
